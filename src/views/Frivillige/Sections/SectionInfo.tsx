    ...
    <div className="volunteersPage--section">
      <div className="volunteersPage--section--div">
        ...
        <p className="volunteer--text" id="volunteer--text">
          ...
          motivasjon og lærelyst. Digital Leksehjelp er en trygg digital
          plattform som bygger på Røde Kors-prinsippene humanitet, upartiskhet,
          nøytralitet, uavhengighet, frivillighet, enhet og universalitet. Les
          mer om prinsippene{' '}
          <a
